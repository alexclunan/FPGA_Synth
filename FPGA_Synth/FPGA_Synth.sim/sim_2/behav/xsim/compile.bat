...
REM
REM Generated by Vivado on Tue Sep 23 01:50:23 -0400 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_LFO_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_LFO_vlog.prj -log xvlog.log
