...
HD_PWD='C:/Users/Alex/Documents/Personal Tech Projects/FPGA-ASIC Synth/FPGA_Synth/FPGA_Synth.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LFO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LFO.tcl
